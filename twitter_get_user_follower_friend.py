...
def paginate(items, n):     #Generate n-sized chunks from items
...
if __name__ == '__main__':
	...
	if len(sys.argv) !=2:      #if the command on terminal is wrong print how to use it
		usage()
		sys.exit(1)
